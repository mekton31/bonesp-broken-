...
namespace bonesp
{
    public class Reader //we will add more reding shits
    {
        Swed swed;
        ...
        public List<Vector3> ReadBones(IntPtr boneAddress)
        {
            ...
            foreach (var boneId in Enum.GetValues(typeof(BoneIds))) //loop thrpuhj enum
            {
        ...
        public ViewMatrix readMatrix(IntPtr maxtrixAddress)
        {
            var viewMatrix = new ViewMatrix();
            var matrix = swed.ReadMatrix(maxtrixAddress);
